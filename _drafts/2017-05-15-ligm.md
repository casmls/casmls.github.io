...
As a consequence, it is important to distingush between the choice of model, the choice of inference and the resulting choice of algorithms; within this, it is perhaps worth noting that although GANs have some promise, they i) are only a choice of algorithm, and ii) currently have some severe practical limitations in certain scenarios (see e.g [6]).
...
[6] How not to train you generative model paper
