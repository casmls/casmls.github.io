...
Assumptions 1 and 3 appear reasonable. The assumption that deserves the most scrutiny is assumption 2, as indeed, it guides many of the proofs in the paper. We note that if $$X$$ is bounded, assumption 2 holds.

### Results

The main result of this paper is **Theorem 1** which has three parts. If $$n \geq Cd \log d$$ for some constant $$C$$,
