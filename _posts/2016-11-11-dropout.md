...
This week, we read Gal and Ghahramani's "Dropout as a Bayesian Approximation: Representing Model Uncertainty in Deep Learning" [1], as well as "Deep Networks with Stochastic Depth" by Huang et. al [2]. The two papers differed greatly in scope: Gal and Ghahramani looks at Dropout from a Bayesian point of view and casts it as approximate Bayesian inference in deep Gaussian Processes while Huang et al. demonstrated the possibility of incorporating Dropout in the Resnet architecture.

<!--more-->

_The figures and tables below are taken from these papers._
